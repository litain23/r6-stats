...
public class Operators {
    ...
    @Builder
    public Operators(String name, String index, int uniqueStatisticPvp, int kills, int death, int headshot, int meleekills, int totalxp, int timeplayed, int roundwon, int roundlost) {
        this.name = name;
        this.index = index;
